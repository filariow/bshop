...
func (r *BeerRepository) Create(ctx context.Context, beer bshop.Beer) (uint64, error) {
	r.mux.Lock()
	defer r.mux.Unlock()
...
func (r *BeerRepository) Read(ctx context.Context, id uint64) (bshop.Beer, error) {
	r.mux.RLock()
	defer r.mux.RUnlock()
...
func (r *BeerRepository) Delete(ctx context.Context, id uint64) error {
	r.mux.Lock()
	defer r.mux.Unlock()
